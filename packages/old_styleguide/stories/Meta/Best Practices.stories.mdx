...
<Box bg="navy-400" border={1} color="white" mx={16} p={16}>
  <Text smooth>
    Share your css methods easily with <code>StyleProps</code> from
    <code>gamut-styles</code>!
  </Text>
</Box>
...
<Box bg="navy-400" border={1} color="white" mx={16} p={16} mb={32}>
  <Text smooth>
    <Text as="strong">Tip:</Text> If you wish to skip a breakpoint in using the
