...
export const FeaturedStat: React.FC<GenericChildrenType> = ({ children }) => (
  <Text
    as="div"
    variant="title-xxl"
    fontSize={{ _: 44, lg: 64 }}
...
export interface FeaturedTitleProps extends GenericChildrenType {
...
export interface FeatureProps extends GenericChildrenType {
  testId?: string;
}
