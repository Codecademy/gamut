...
export var footerResourcesList = [{
  id: 'projects',
  href: '/projects',
...
export var headerResourcesList = [{
  title: 'Docs',
  description: 'Find definitions, code syntax, and more -- or contribute your own code documentation.',
  link: {
    text: 'View all docs',
    href: '/resources/docs',
    id: 'view-all-docs',
