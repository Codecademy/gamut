...
export var refreshedResourcesDropdown = {
...
export var favorites = function favorites(renderFavorites) {
  return {
    id: 'favorites',
...
export var bookmarks = function bookmarks(renderBookmarks) {
  return {
    id: 'bookmarks',
...
export var proProfile = function proProfile(user) {
  ...
  if (user !== null && user !== void 0 && user.isAccountManager || user !== null && user !== void 0 && user.isBusinessAdmin) {
    topSection.push(profileBusinessAccount);
  }
