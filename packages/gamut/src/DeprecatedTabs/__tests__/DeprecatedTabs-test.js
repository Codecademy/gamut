...
describe('Accessible Tabs', () => {
  ...
  it('allows prop config to specify default tab and show appropriate tab panel', () => {
    const wrapper = shallow(
      React.createElement(
        ...
        React.createElement('div', null, 'Tab 1'),
        React.createElement('div', null, 'Tab 2')
      )
    );
    expect(
      wrapper
  ...
  it('Shows the correct tab panel on click, with proper tab highlighted via animated underline', () => {
    const wrapper = mount(
      React.createElement(
        Tabs,
        { config: generateTabConfig(2), animatedUnderlineStyle: true },
        React.createElement('div', null, 'Tab 1'),
        React.createElement('div', null, 'Tab 2')
      )
    );
  ...
  it('calls the onChange function provided in props when tabs change', () => {
    ...
    const wrapper = mount(
      React.createElement(
        Tabs,
        { config: generateTabConfig(2), onChange: onChange },
        React.createElement('div', null, 'Tab 1'),
        React.createElement('div', null, 'Tab 2')
      )
    );
...
//# sourceMappingURL=DeprecatedTabs-test.js.map
