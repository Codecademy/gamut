...
const TrophyIcon = props => {
  return React.createElement(
    'svg',
    Object.assign({}, props),
    React.createElement('title', null, 'Trophy Icon'),
    React.createElement(
      'g',
      { fillRule: 'nonzero' },
      React.createElement('path', {
        d:
          'M6.503 3.801v5.404a5.404 5.404 0 1 0 10.808 0V3.801H6.503zm6.305 12.554V19h2.894v1h-8v-1h3.304v-2.645a7.206 7.206 0 0 1-6.304-7.15V2h14.41v7.205a7.206 7.206 0 0 1-6.304 7.15zm-7.205 4.559h12v1h-12v-1z',
      }),
      React.createElement('path', {
        d:
