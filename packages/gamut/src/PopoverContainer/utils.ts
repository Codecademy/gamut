 ...
 *   `useLogicalProperties` is enabled.
 * - `physicalStyles`: applied as an inline `style` prop for `transform` and for centered
 *   `top`/`bottom` horizontal anchors (`left` + `translate(-50%, 0)`).
 */
