...
type ButtonBaseProps =
  | CompatibleComponentProps<typeof ResetElement>
  | (Exclude<CompatibleComponentProps<typeof ResetElement>, 'ref'> &
      CompatibleComponentProps<typeof ResetElementAnchor>);
