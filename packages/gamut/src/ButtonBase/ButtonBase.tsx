...
const ResetElement = createComponent('button', styledOptions<'button'>())(resetStyles);
const ResetElementAnchor = createComponent('a', styledOptions<'a'>())(resetStyles);

type ButtonBaseProps = ButtonBaseElementProps;
