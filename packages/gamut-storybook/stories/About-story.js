...
storiesOf("About", module).add("Welcome", () => {
  return (
    <div>
      ...
      <p>
        This storybook displays components, as well as some basic style building blocks in the "Visual" top-level folder,
        such as <a href="/?selectedKind=Visuals%2FColors&selectedStory=Portal">color variables</a>.
