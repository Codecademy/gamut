...
If you enable the `clickOutsideDeactivates` prop, your Modal will close whenever the user clicks outside of the content of the modal.

By default, clicking the escape key on your keyboard will close an active Modal. You can deactivate this by setting the `escapeDeactivates` prop to false.
