...
import { ButtonDeprecated, Modal, Text, Overlay } from '@codecademy/gamut/src';
...
<Meta
  ...
  parameters={{
    ...
    source: 'gamut',
    figma:
      'https://www.figma.com/file/yt7NdZTETDRPUn0CtRu3v0/Modals-(Yassine%3A-Retheme-%2B-Add-Variants-%2B-Update-Guidelines)?node-id=26%3A4',
  }}
/>
