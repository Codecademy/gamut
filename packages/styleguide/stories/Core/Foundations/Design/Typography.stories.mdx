...
<Meta
  title="Foundations/Design Guidelines/Typography"
  parameters={{ figmaId: 'rNsdbOwlw6L0ea3uAJrrz7' }}
/>

For more checkout out our theme documentation for how to access and use all [typography design tokens](?path=/docs/foundations-theme--page#typography)
