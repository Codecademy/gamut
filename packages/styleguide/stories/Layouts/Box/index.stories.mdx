...
specific components to handle those in addition to everything that Box does! <LinkTo kind="/Layouts/Box/GridBox">GridBox</LinkTo> and <LinkTo kind="/Layouts/Box/FlexBox">FlexBox</LinkTo>
