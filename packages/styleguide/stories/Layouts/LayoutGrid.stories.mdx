...
Both these properties can take a [responsive size](?path=/docs/foundations-layout--page#screensizes-and-media-queries),allowing you to define gaps at each breakpoint.

<!-- TODO: We should have page that surfaces the $gapSize in packages/gamut/src/Layout/styles/_variables.scss -->
