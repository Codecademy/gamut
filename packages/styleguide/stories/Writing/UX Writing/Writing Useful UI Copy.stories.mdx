...
For best practices for writing for specific components, like alerts, errors, or confirmation dialogs, check out our documentation on <LinkTo id="writing-ux-writing-writing-for-components-about--page">writing for components</LinkTo>.
