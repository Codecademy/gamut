...
import { theme } from '@codecademy/gamut-styles/src';
...
<Meta
  title={title}
  parameters={{ status: 'current', figmaId: 'ZUJ7cfVgyoh1kiQYNN8Hbt' }}
/>
...
We have 6 main screensizes we design for, these are not the same thing as `breakpoints` which are used to help us achieve these guidelines. You can checkout our <LinkTo id="foundations-theme--breakpoints">Theme</LinkTo>
