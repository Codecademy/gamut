...
Our primary typeface is Aperçu Pro. It is a geometric-ish, humanist-ish sans-serif. Which basically means it gives us a voice that says “We are ruled by logic, but are creative and a bit unexpected as well”. Its weight makes it attention-grabbing in dense layouts, and its legibility allows us to use it for both long-form articles and fine print.
