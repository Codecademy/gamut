...
<Meta
  ...
  parameters={{
    status: 'stable',
    description: 'Semantic color palette configuration',
  }}
/>
...
const Page = ({ children }) => (
  <Background initialBackground="hyper">{children}</Background>;
);
```
...
<BackgroundExample initialBackground="hyper" />

<BackgroundExample initialBackground="beige" />
...
<BackgroundExample initialBackground="black">
  <BackgroundExample initialBackground="paleGreen" />
</BackgroundExample>
