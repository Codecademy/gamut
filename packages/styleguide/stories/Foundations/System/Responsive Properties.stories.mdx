...
We call this the responsive property syntax, and it comes in two forms:
...
Here are some examples of what the expected out put will be for certain configurations:
