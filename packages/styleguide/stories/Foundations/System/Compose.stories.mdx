...
When using custom properties or our standard <LinkTo id="foundations-system-props--page">system props</LinkTo> it can be useful to combine them into a single function using `variance.compose`.
