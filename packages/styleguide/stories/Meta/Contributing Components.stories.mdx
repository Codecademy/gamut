<Meta title="Meta/Contributing Components" />

# Contributing Components

Thanks so much for being interested in contributing components!
We love working with Codecademy employees across all our teams.

> 🏗 We're still building these opinions out; some of this information might still be in flux!
...
See [./Writing Stories](Writing Stories) for documentation.
...
If you know your PR has breaking changes and/or is meant to be used in at least one downstream repository soon _(read: almost all PRs)_:
