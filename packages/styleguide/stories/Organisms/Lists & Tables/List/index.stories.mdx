...
<Story name="Spacing - Normal" args={{ variant: 'default', spacing: 'normal' }}>
  {DemoTemplate.bind({})}
</Story>
...
<Story
  ...
  args={{ variant: 'default', spacing: 'condensed' }}
>
  {DemoTemplate.bind({})}
</Story>
...
<Story name="Default" args={{ variant: 'default', spacing: 'condensed' }}>
  {DemoTemplate.bind({})}
</Story>
...
<Canvas>
  <Story
    name="Scrollable"
    args={{ variant: 'default', spacing: 'condensed', scrollable: true }}
  >
...
<Canvas>
  <Story
    name="Normal - Example"
    args={{ variant: 'default', spacing: 'normal' }}
  >
    {NormalTemplate.bind({})}
  </Story>
</Canvas>
