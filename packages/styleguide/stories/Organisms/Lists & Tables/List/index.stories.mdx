...
For making feature-forward designs (like our Dashboard), or to use as page sections + scaffolding (like our syllabus pages). `block` should always be used on a colored background.
