...
<List variant="base" spacing="condensed">
  <ListRow>
...
<Story name="Spacing - Normal" args={{ variant: 'base', spacing: 'normal' }}>
  {DemoTemplate.bind({})}
</Story>
...
<Story
  ...
  args={{ variant: 'base', spacing: 'condensed' }}
>
  {DemoTemplate.bind({})}
</Story>
...
- `base`: Bordered rows for mixed content with no vertical gutter.
...
For displaying things with more abstract row contents (like buttons or custom rendered components) use the `base` variant. This structure denotes borders between rows and separates interactive elements with more clarity than tables.

<Story name="Base" args={{ variant: 'base', spacing: 'condensed' }}>
  {DemoTemplate.bind({})}
</Story>
...
<Story name="Card" args={{ variant: 'card', spacing: 'condensed' }}>
  {DemoTemplate.bind({})}
</Story>
...
<Canvas>
  <Story
    name="Scrollable"
    args={{ variant: 'base', spacing: 'condensed', scrollable: true }}
  >
...
<Canvas>
  <Story name="Normal - Example" args={{ variant: 'base', spacing: 'normal' }}>
    {NormalTemplate.bind({})}
  </Story>
</Canvas>
