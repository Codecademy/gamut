...
Additional links outside of an accordion can be added to the bottom as `children`. Another way to add additional links outside of the accordion section is to pass an array of items that each contain a title, slug, and onClick to topLinkSections. Each of these items will become a link on top of the accordion section.
