...
<Meta
  title={title}
  parameters={{
    subtitle: 'Ya gotta submit data somehow!',
  }}
/>
...
We reccommend GridForm if you have a form that sticks to a 12x12 visual grid with consistent vertical rhythm and grid spacing.

For everything else, we reccommend ConnectedForm.
