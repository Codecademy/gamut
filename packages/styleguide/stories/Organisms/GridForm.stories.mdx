...
We can use the `size` and `rowspan` props (borrowed from [LayoutGrid](https://react-hook-form.com)) to customize the layout of your GridForm.

<Canvas>
  <Story name="rowspanformatting">
    {(args) => (
      <GridForm
        fields={[
          {
