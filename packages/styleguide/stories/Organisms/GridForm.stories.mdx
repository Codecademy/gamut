...
We also have a 'custom-group' type for when you are passing in a custom FormGroup. If you do not want GridForm to surface errors, you should likely use a 'custom-group'.
