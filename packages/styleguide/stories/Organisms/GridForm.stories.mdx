          ...
          fields={[
            ...
            },
            {
              ...
              fields: [
                ...
                {
                  label: 'Write a paragraph.',
                  name: 'paragraph01-custom-section',
                  size: 12,
                  type: 'textarea',
                  validation: {
                    required: 'Please write something about penguins!',
            ...
            },
            {
              ...
              fields: [
                ...
                {
                  label: 'Write a paragraph.',
                  name: 'paragraph01-custom-section-2',
                  size: 12,
                  type: 'textarea',
                  validation: {
                    required: 'Please write something about penguins!',
            ...
            },
            {
              ...
              fields: [
                ...
                {
                  label: 'Write a paragraph.',
                  name: 'paragraph01-custom-section-3',
                  size: 12,
                  type: 'textarea',
                  validation: {
                    required: 'Please write something about penguins!',
            ...
            {
              title: 'custom section-4',
              layout: { size: 4 },
              variant: 'title-xs',
              fields: [
                {
                  label: 'hi?',
                  name: 'text01-custom-section-4',
                  size: 12,
                  type: 'text',
                  validation: {
                    required: true,
                ...
                {
                  label: 'Write a paragraph.',
                  name: 'paragraph01-custom-section-4',
                  size: 12,
                  type: 'textarea',
                  validation: {
                    required: 'Please write something about penguins!',
            ...
            {
              title: 'custom section-5',
              layout: { size: 4 },
              variant: 'title-xs',
              fields: [
                {
                  label: 'hi?',
                  name: 'text01-custom-section-5',
                  size: 12,
                  type: 'text',
                  validation: {
                    required: true,
                ...
                {
                  label: 'Write a paragraph.',
                  name: 'paragraph01-custom-section-5',
                  size: 12,
                  type: 'textarea',
                  validation: {
                    required: 'Please write something about penguins!',
            ...
            {
              title: 'custom section-6',
              layout: { size: 4 },
              variant: 'title-xs',
              fields: [
                {
                  label: 'hi?',
                  name: 'text01-custom-section-6',
                  size: 12,
                  type: 'text',
                  validation: {
                    required: true,
                ...
                {
                  label: 'Write a paragraph.',
                  name: 'paragraph01-custom-section-6',
                  size: 12,
                  type: 'textarea',
                  validation: {
                    required: 'Please write something about penguins!',
...
blah blah blah another thing blah blah blah blah

<Canvas>
  <Story name="Sections ii">
    {(args) => {
      return (
        <GridForm
          fields={[
