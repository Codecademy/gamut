...
We can specify the version of our button by passing the buttonType prop. WE can choose between
the [`FillButton`](/?path=/docs/atoms-button--fill-button) or [`CTAButton`](?path=/docs/atoms-button--cta-button).
