...
hideRequiredText `hideRequiredText` will hide the ;\* Required' text that appears at the top of our forms. This should only be hidden if the form has no required fields.
