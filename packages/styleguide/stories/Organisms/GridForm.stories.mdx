...
This is will disable fields once the GridForm has been successfully submitted. If you have any server validation that needs to happen, be sure to have an error handler in your `onSubmit` or in the custom `validate` function in validation of your field.
