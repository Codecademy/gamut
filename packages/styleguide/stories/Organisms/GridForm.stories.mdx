    ...
    {(args) => {
      return (
        <GridForm
          fields={[
            {
              title: { title: 'hi there', as: 'h3', size: 3, rowspan: 3 },
              fields: [
                {
                  label: 'hi?',
                  name: 'input-custom-section-1',
                  size: 5,
                  type: 'text',
                  validation: {
                    required: true,
            ...
            {
              title: { title: 'hi again' },
              fields: [
                {
                  label: 'helo?',
                  name: 'input-custom-section-4',
                  size: 5,
                  type: 'text',
                  validation: {
                    required: true,
