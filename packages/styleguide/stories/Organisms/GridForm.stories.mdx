...
You can set the rest of the [Text](https://gamut.codecademy.com/storybook/?path=/docs/typography-text--text) props for the section title the same way. Please check if your styling can be achieved with a [variant](https://gamut.codecademy.com/storybook/?path=/docs/typography-text--text#1-element-variants) before exploring other props.
