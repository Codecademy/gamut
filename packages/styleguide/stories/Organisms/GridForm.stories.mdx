...
Hidden inputs can be used to include data that users can't see or modify with the submission. For this implementation you can simply set the `defaultValue` in the object and it will be submitted with the regular form data.
