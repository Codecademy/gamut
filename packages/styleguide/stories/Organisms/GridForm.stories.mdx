...
GridForm can optionally render errors through our <LinkTo id="atoms-markdown--basics">Markdown</LinkTo> component and our markdown prop. This should be used sparingly.
