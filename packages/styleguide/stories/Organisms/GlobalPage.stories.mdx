...
<Meta
  ...
  parameters={{
    ...
    subtitle:
      'Global page consisting of a SkipToContent control and children between a GlobalHeader and GlobalFooter, optionally with a background color.',
  }}
/>
...
General-use container for a full page consisting of a header, <LinkTo kind='Atoms/SkipToContent'>SkipToContent</LinkTo>, some page contents, and a footer.
