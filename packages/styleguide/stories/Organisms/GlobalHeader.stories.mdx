...
import { BackpackIcon, BellIcon } from '@codecademy/gamut-icons/src';
...
### GlobalHeader With Search and Notifications and Learner Backpack

To mock this, IconButtons are provided as placeholders. \*Pending backpack icon, I used a notebook for now.

<Canvas>
  <Story name="GlobalHeader With Search, Notifications, and Backpack">
    {(args) => (
      <GlobalHeader
        action={() => {}}
        renderNotifications={{
        ...
        renderLearnerBackpack={{
          desktop: () => <IconButton icon={BackpackIcon} />,
        }}
        search={{
          onEnable: () => {},
          onSearch: () => {},
