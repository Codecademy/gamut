...
import { BellIcon, StarIcon } from '@codecademy/gamut-icons/src';
...
### GlobalHeader With Search, Notifications, and Favorites

To mock this, IconButtons are provided as placeholders.

<Canvas>
  <Story name="GlobalHeader With Search, Notifications, and Favorites">
    {(args) => (
      <GlobalHeader
        action={() => {}}
        renderNotifications={{
        ...
        renderFavorites={{
          desktop: () => <IconButton icon={StarIcon} />,
        }}
        search={{
          onEnable: () => {},
          onSearch: () => {},
