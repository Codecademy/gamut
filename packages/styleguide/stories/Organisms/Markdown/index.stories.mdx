...
Img tags are overwitten by the `PauseableImage` component because of the accessibility benefits it provides.
When provided with a Gif it will allow it to be be pauseable.
