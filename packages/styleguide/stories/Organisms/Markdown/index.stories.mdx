...
When provided with a Gif it allow the user to pause the gif.
    ...
    <LayoutGrid gap={16}>
      ...
      <Column size={6}>
        <Markdown
          spacing="none"
          text={
            '<a href="/yolo"> <img alt="demonstration of learning environment" src="//images.ctfassets.net/go6kr6r0ykrq/2vjTCK9DmJ6BOd5NtFxNIG/e5ced4209aef5241cd581841fa6e2511/learn-css_box-model_06.16.gif" ></a>'
          }
        />
      </Column>
    </LayoutGrid>
