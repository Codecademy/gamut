...
GlobalHeader variants are documented in the sibling stories to this documentation, listed <MyLink id="brand-labs-organisms-globalheader-about--page">in the GlobalHeader folder.</MyLink>
