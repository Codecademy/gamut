...
<CustomCheckbox
  htmlFor="buttons-1"
  label="For buttons, is your copy 3 words or less?"
  spacing="tight"
/>
<CustomCheckbox
  htmlFor="buttons-2"
  label="For buttons, have you used action-oriented language?"
  spacing="tight"
/>
<CustomCheckbox
  htmlFor="buttons-3"
  label="Have you used sentence case, only capitalizing proper nouns?"
  spacing="tight"
/>
<CustomCheckbox
  htmlFor="buttons-4"
  label="Does the copy make it clear where the link will take learners?"
  spacing="tight"
/>
