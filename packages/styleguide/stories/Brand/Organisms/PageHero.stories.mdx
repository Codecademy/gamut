...
<Canvas>
  <Story name="Eyebrow">
    {(args) => <PageHero {...args} eyebrow="Hello there" textLength="short" />}
  </Story>
</Canvas>

## Accent Eyebrow

Add the `accentEyebrow` prop to change the eyebrow text color to `#1557FF`. If you are using this component with a page or section background color, please ensure that the contrast meets accessibility guidelines.
