...
import { BasicGlobalHeader } from '@codecademy/gamut-labs/src';
...
<Canvas withSource="open">
  <Story name="BasicGlobalHeader - this is just the global header w/out the animations">
    {(args) => (
...
<PropsTable story="BasicGlobalHeader" />
...
<Canvas>
  <Story name="Anonymous User - Default">
    {(args) => <BasicGlobalHeader action={() => {}} type="anon" />}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Anonymous User - Landing Page">
    {(args) => (
      <BasicGlobalHeader action={() => {}} type="anon" variant="landing" />
    )}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Loading">
    {(args) => <BasicGlobalHeader action={() => {}} type="loading" />}
  </Story>
</Canvas>
