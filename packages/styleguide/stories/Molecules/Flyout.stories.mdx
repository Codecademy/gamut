...
<Meta
  ...
  parameters={{
    subtitle:
      'Flyout is a general container that is mobile/tablet menu navigation. On button click, a container animates in from the left side of the window. It can be configured to close by pressing the "X" close icon, pressing they "esc" key, and/or clicking outside of the container.',
    source: 'gamut-labs',
    status: 'updating',
  }}
/>
