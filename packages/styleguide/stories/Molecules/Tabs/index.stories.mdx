  ...
  <Story name="Tabs">
    {(args) => (
      <Tabs {...args}>
        ...
        <TabPanel>
          <DeprecatedHeading as="h2">Welcome to Tab 1</DeprecatedHeading>
          <Text>Hi there! I&apos;m the contents inside Tab 1. Yippee!</Text>
        </TabPanel>
        <TabPanel>
          <DeprecatedHeading as="h2">Welcome to Tab 2</DeprecatedHeading>
          <Text>Hi there! I&apos;m the contents inside Tab 2. Yippee!</Text>
        </TabPanel>
        <TabPanel>
          <DeprecatedHeading as="h2">Welcome to Tab 3</DeprecatedHeading>
