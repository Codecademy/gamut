  ...
  <Story name="Flyout">
    {(args) => (
      <Box height="20rem">
        <FlyoutExample {...args} />
        <FlexBox>
          yo An Avatar of Khaine is the term normally applied to the physical
          ...
          Mensha Khaine, though the term can actually apply to any divine entity
          of the Warp that has found some way to take on a corporeal form within
          realspace.
        </FlexBox>
      </Box>
    )}
