...
<Meta
  ...
  parameters={{
    ...
    design: {
      type: 'figma',
      url:
        'https://www.figma.com/file/ReGfRNillGABAj5SlITalN/%F0%9F%93%90-Gamut?node-id=30186%3A40359',
    },
    padded: true,
  }}
  args={{
...
<Story name="Small width feature" args={ALERTS.feature}>
  {(args) => <Box width="400px"><Alert {...args} /></Box>}
</Story>
