...
<LayoutGrid gap={24} mt={32}>
<Column size={6} display="block">

### Small

<Canvas>
  <Story name="Small" args={{ size: 'small' }} height="350px">
    {(args) => <Modal {...args} />}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Medium" args={{ size: 'medium' }} height="350px">
    {(args) => <Modal {...args} />}
  </Story>
</Canvas>
...
<Canvas>
  <Story
    ...
    args={{
      size: 'fluid',
      children: <FlexBox height="350px" width="800px" bg="beige" />,
    }}
    height="500px"
  >
    {(args) => <Modal {...args} />}
