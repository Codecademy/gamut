import { Dialog, DialogOverlay } from '@codecademy/gamut/src';
...
<Canvas>
  <Story name="Dialog" height="400px">
    {(args) => {
      return <DialogOverlay isOpen inline {...args} />;
    }}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Light Mode" height="400px">
    {(args) => <DialogOverlay inset isOpen {...args} />}
  </Story>
</Canvas>

<Canvas>
  <Story name="Dark Mode" height="400px">
    {(args) => {
      return (
        <Background bg="navy" height={1}>
          <DialogOverlay inset isOpen {...args} />
        </Background>
      );
    }}
  </Story>
