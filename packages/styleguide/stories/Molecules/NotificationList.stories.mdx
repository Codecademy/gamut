...
When writing copy for a notification, keep it brief, make it actionable, and ensure the messaging is in support of the learner’s journey. Refer to the checklist below for guidance.

- [ ] Only use a notification when there is a relevant action for the learner to take.
- [ ] Ensure that the action is clear.
- [ ] Keep notifications to 86 characters or less (a maximum of 3 lines).
