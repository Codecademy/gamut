...
- Should NOT repeat as a notification bell

### Key Principles

- Only one should appear at the screen at a time.
- Toasts shouldn’t be distracting learning. Be cautious to use them in the Learning Environment, especially for messages that can be communicated outside of LE.
