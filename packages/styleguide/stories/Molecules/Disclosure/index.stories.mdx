...
<Canvas>
  ...
  >
    {(args) => <Background bg="background-primary"><Disclosure {...args} /></Background>}
  </Story>
</Canvas>
...
<Canvas>
  <Story
    ...
    args={{
      ...
      body: 'Notice the border and it uses `background-selected`. For this example there is a `<Background>` set to `"background-primary"`.'
    }}
  >
    {(args) => <Background bg="background-primary"><Disclosure {...args} /></Background>}
  </Story>
...
<Canvas>
  <Story
    ...
    args={{
      ...
      body: 'Notice the border and it uses `background-current` to inherit the existing background color. For this example there is a `<Background>` set to `"primary-inverse"`.'
    }}
  >
    {(args) => <Background bg="primary-inverse"><Disclosure {...args} /></Background>}
  </Story>
</Canvas>
...
<Canvas>
  <Story
    ...
    args={{
      ...
      body:
        'Notice the LACK of border and it uses `background`',
    }}
  >
