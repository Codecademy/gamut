...
## ListSection with custom spacing between list elements.

You can provide the optional `listItemGap` prop to adjust the spacing between list item elements.

<Canvas>
  <Story name="ListSection with custom spacing between list elements">
    {(args) => (
      <>
        <ListSection
          {...args}
          title="List Section with small spacing"
          headerButton={{ text: 'Edit', href: '', onClick: () => {} }}
          headerSecondaryButton={{ text: 'Share', href: '', onClick: () => {} }}
          listItemGap={4}
        >
        ...
        <ListSection
          {...args}
          title="List Section with large spacing"
          headerButton={{ text: 'Edit', href: '', onClick: () => {} }}
          headerSecondaryButton={{ text: 'Share', href: '', onClick: () => {} }}
          listItemGap={32}
        >
