...
Popovers have a secondary, tooltip-esque variant style that have a smaller beak, base font size, and different background colors. Check it out in light mode and dark mode!

<Canvas>
  <Story name="Variant">
    {(args) => {
      return <PopoverWithoutFocus beak="left" variant="secondary" {...args} />;
    }}
  </Story>
</Canvas>
