...
<Canvas>
  <Story name="Anchor">
    {(args) => {
      return (
        <>
          <Anchor {...args} icon={MiniStarIcon}>I am a cool link</Anchor>{" "}
          <Anchor {...args} variant="standard" icon={MiniArrowLeftIcon}>I am a cool link</Anchor> {" "}
          <Anchor {...args} variant="interface" iconPosition="right" icon={MiniThumbsUpIcon}>I am a cool link</Anchor>
        </>)
    }}
  </Story>
</Canvas>
