...
import { MiniInfoOutlineIcon, MiniStarIcon } from '@codecademy/gamut-icons';
...
<Canvas>
  <Story name="Anchor with Icon">
    {(args) => {
      return (
        <Text>
          I started painting as a hobby when I was little. I didn't know I had any talent. I believe talent is just a pursued interest. <Anchor {...args} href="/" icon={MiniStarIcon} iconPosition="left" variant="inline"> Anybody can do what I do.</Anchor> Just go back and put one little more happy tree in there. Everybody's different. Testing
        </Text>
      )
    }}
  </Story>
