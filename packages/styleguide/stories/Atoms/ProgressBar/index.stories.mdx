...
This is a variant of the ProgressBar, which can be used to show a percentage of star ratings for a course. It features a yellow percentage bar on a white background.
