...
This is a variant of the ProgressBar that has a transparent background and "bordered" look. borderedDarkMode should be displayed against a dark background and borderedLightMode should be placed against a light background.

### Bordered Dark Mode

<Canvas column={2}>
  <Story
    name="Bordered - Dark Mode"
    args={{
      percent: 50,
      variant: 'borderedDarkMode',
      width: '150px',
    }}
  >
    {(args) => (
...
<Canvas column={2}>
  <Story
    name="Bordered - Light Mode"
    args={{
      percent: 42,
      variant: 'borderedLightMode',
      width: '150px',
    }}
  >
    {(args) => (
...
### Bordered Dark Mode Large

<Canvas column={2}>
  <Story
    name="Bordered - Light Mode - Large"
    args={{
      pattern: 'diagonalStripesDense',
      percent: 71,
      variant: 'borderedDarkMode',
