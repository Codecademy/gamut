...
This is a variant of the ProgressBar that has a transparent background and "bordered" look. borderedLight should be displayed against a dark background and borderedDark should be placed against a light background.
