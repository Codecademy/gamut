...
Using the new SVG Pattern component for the background. Here we are using the DiagonalBRegular Pattern in navy in the large ProgressBar and the DiagonalBDense pattern in the smaller ProgressBar.
