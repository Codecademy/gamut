...
2. Select the Outline version of the icon as opposed to stroke. You will not be able to get this from the App, and you must find the icon's outline version in [our assets](https://drive.google.com/drive/folders/1y0etPCUHGeU19Jp2UK0IG7Ku0oGka095?usp=sharing).
