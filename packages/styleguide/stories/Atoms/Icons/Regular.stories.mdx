...
2. Select the Stroke version of the icon as opposed to Otroke. You will not be able to get this from the App, and you must find the icon's stroke version in our assets.
