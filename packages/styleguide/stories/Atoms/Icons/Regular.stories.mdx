...
2. Select the Stroke version of the icon as opposed to Outline. You will not be able to get this from the App, and you must find the icon's stroke version in our assets.
   You can check to see if an Icon is stroke by if it has any `stroke-width: 1.5px` rules in its markup, outline will not have this.
