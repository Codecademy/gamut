...
We support the following variants of Badges: `default`, `grey`, `stroke`, and `yellow`.
...
- `default` when the Badge is a standalone entitity (24px tall)
- `sm` when the Badge is inline with other components or `Text` (16px tall)
