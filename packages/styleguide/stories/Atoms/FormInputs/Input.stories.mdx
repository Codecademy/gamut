...
import { ViewIcon, AmexIcon, StreakIcon } from '@codecademy/gamut-icons';
...
<Canvas>
  <Story
    name="FormCusomtExamples"
    args={{
      htmlFor: 'example-12dfsa3',
      defaultValue: '12asdf3',
      name: 'example-1asf23',
      icon: ViewIcon,
    }}
  >
...
import { AmexIcon, StreakIcon } from '@codecademy/gamut-icons';
