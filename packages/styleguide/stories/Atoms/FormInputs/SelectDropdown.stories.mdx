...
You can chose how options will be shown in the dropdown, with 6 being the default and the max.

This assumes all of your options are one line.
...
<Canvas>
  ...
  >
    {(args) => (
      <Box width="25rem" height="25rem">
        <FormGroup
          label="i have the default shownOptions"
  ...
  >
    {(args) => (
      <Box width="25rem" height="25rem">
        <FormGroup
          label="i have three shownOptions but i am small"
          htmlFor="shownOptions02"
        >
