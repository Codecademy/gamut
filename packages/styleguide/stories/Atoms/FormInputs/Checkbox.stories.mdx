...
<Canvas>
  <Story name="Tight Spacing">
    <Checkbox checked readOnly variant="tight" label="a small space" />
    <Checkbox variant="tight" label="with three checkboxes" />
    <Checkbox checked readOnlyvariant="tight" label="neat huh?" />
  </Story>
</Canvas>
