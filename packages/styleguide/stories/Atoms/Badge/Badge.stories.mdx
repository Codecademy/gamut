...
<Canvas>
  ...
  <Story name="default size FOR TESTING" args={{ children: 'DEFAULT' }}>
    {BadgeTemplate.bind({})}
  </Story>
  <Story
    name="small"
  ...
  <Story
    name="small FOR TESTING"
    args={{ children: 'SMALL', size: 'sm', variant: 'tertiary' }}
  >
    {BadgeTemplate.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  ...
  <Story
    name="another sample icon FOR TESTING"
    args={{
      children: 'IN CAPS',
      variant: 'tertiaryFill',
      icon: MiniStarIcon,
  ...
  <Story
    name="different test icon FOR TESTING"
    args={{
      children: 'another icon',
      variant: 'tertiaryFill',
      icon: MiniPinIcon,
    }}
  >
  ...
  <Story
    name="different icon FOR TESTING"
    args={{
      children: 'IN CAPS',
      variant: 'tertiaryFill',
      icon: MiniPinIcon,
  ...
  <Story
    name="small icon caps FOR TESTING"
    args={{
      children: 'SMOL',
      size: 'sm',
      variant: 'accent',
