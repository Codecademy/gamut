...
Tooltips can be hidden at various breakpoints. They're shown at all by default, but you can go wild (not that you should) and show/hide tooltips at certain ranges
