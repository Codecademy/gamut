...
The LX Studio Theme is a theme used within the LX Studio. It is built off of the Core Theme with additional tokens and overrides for the LX Studio. See <LinkTo id="Foundations/Theme/CoreTheme">Core Theme</LinkTo> for more information on the theme object and how to use it.
