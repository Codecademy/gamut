...
- comment: `white-500` (light) and `navy-500` (dark)
- indent-active: `white-300` (light) and `navy-300` (dark)
- indent-inactive: `white-400` (light) and `navy-400` (dark)
- line-number-active: `white-700` (light) and `navy-700` (dark)
- line-number-inactive: `white-500` (light) and `navy-500` (dark)
