...
The Platform Theme is a theme used within the Codecademy Learning Environment. It is built off of the Core Theme with special colors for the Learning Environment. See <LinkTo id="Foundations/Theme/CoreTheme">Core Theme</LinkTo> for more information on the theme object and how to use it.
