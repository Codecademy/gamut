...
<Canvas of={BoxStories.FigmaLanding} />

## Figma MCP Landing Page

This is a complete landing page demonstrating the Figma to code workflow using MCP (Model Context Protocol). It showcases real Gamut components that can be inspected in Figma Dev Mode to generate production-ready React code.

<Canvas of={BoxStories.FigmaMcpLanding} />
