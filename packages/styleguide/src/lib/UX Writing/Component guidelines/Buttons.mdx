...
Buttons enable our learners to "speak" to us. They select buttons to tell us what they want (for example, to "Start my free trial" or to "Resume learning") and we respond with the anticipated next step.
...
- Have you used sentence case, only capitalizing proper nouns [link to glossary]?
