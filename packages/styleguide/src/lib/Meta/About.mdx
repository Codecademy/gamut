...
import { parameters as deprecatedPlatformColorsParameters } from './Deprecated platformColors.mdx';
import { parameters as deprecatedEditorColorsParameters } from './EditorColors.mdx';
...
<TableOfContents
  links={addParentPath(parameters.id, [
    ...
    deprecatedPlatformColorsParameters,
    deprecatedEditorColorsParameters,
