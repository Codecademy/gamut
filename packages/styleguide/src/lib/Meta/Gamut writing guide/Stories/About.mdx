...
import { parameters as componentMdxParameters } from './Component MDX.mdx';
import { parameters as componentStoryTsxParameters } from './Component story tsx.mdx';
...
<TableOfContents
  links={addParentPath(parameters.id, [
    componentStoryTsxParameters,
    componentMdxParameters,
