...
<Callout text="Use the /gamut-docs skill in Cursor or Claude Code for AI-assisted help applying this guide — component .mdx pages, .stories.tsx files, About pages, and prop JSDoc." />
