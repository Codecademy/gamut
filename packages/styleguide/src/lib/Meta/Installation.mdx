...
```bash
yarn add @codecademy/gamut-kit @emotion/react @emotion/styled sass
```
...
You may need to add "css-loader", "sass-loader", and/or "sass-embedded" to your package.json depending on your repository's current tooling.

```bash
yarn add css-loader sass-loader sass-embedded
```
