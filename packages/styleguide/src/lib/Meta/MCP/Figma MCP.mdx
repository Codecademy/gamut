...
export const parameters = {
  id: 'Figma MCP [BETA]',
  title: 'Figma MCP [BETA]',
  subtitle:
    'Set up the Figma MCP locally to enable design to code generation, exclusive to Codecademy + Skillsoft employees.',
  status: 'updating',
};

<Meta title="Meta/MCP/Figma MCP [BETA]" />

<AboutHeader {...parameters} />

<Callout text="Any MCP generated code is EXPERIMENTAL! You should always validate the code generated and adapt it to your own needs. Additionally, you must have a Dev or Full account to be able to be able to use the Figma MCP." />
