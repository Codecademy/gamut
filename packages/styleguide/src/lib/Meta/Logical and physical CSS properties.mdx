...
import { AboutHeader, Callout, ImageWrapper, TokenTable } from '~styleguide/blocks';
...
<TokenTable
  idKey="prop"
  columns={[
    { key: 'prop', name: 'Prop', size: 'sm' },
    { key: 'physical', name: 'Physical', size: 'xl' },
    { key: 'logical', name: 'Logical', size: 'xl' },
  ]}
  rows={[
