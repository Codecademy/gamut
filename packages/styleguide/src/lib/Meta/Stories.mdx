...
- `toc-storyk`: A simple template for a Table of Contents category page.
...
Once you've found it create a new folder with two new files `#{COMPONENT_NAME}.stories.tsx` and `#{COMPONENT_NAME}.mdx`. You can also store examples or other associted utility files in this folder.

In your new files you can use the above snippets to set up your component or add:
...
The Flagship story for a component should be intended to give the reader a broad overview of its high-level functionality.
