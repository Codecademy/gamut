...
- **Compact inputs**: Keep the input narrow while showing full details in the dropdown
- **Data-heavy options**: Show abbreviated text in input, full details in dropdown
- **Mobile optimization**: Narrow inputs on mobile, wider dropdowns for readability
- **Form layouts**: Maintain consistent input widths while allowing flexible dropdown content
...
<SelectDropdown options={options} inputWidth="150px" dropdownWidth="350px" />;
```
