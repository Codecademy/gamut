...
- **Accessibility**: Screen readers announce the full label, not the abbreviation
...
- **Independent sizing**: The input and dropdown can have completely different widths
- **Responsive**: Works with both small and medium size variants
