...
<TableOfContents
  links={[
    {
      id: `Atoms/${parameters.title}/${miniParameters.title}`,
      subtitle: miniParameters.subtitle,
      title: miniParameters.title,
      status: miniParameters.status,
    },
    {
      id: `Atoms/${parameters.title}/${regularParameters.title}`,
      subtitle: regularParameters.subtitle,
      title: regularParameters.title,
      status: regularParameters.status,
    },
  ]}
/>
