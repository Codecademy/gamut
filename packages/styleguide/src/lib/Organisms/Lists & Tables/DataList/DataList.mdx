...
When a DataList is scrollable, you can set the `shadow` prop to `true` to add a shadow effect that indicates the presence of additional content.

<Canvas of={DataListStories.ScrollableWithShadow} />
