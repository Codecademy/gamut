...
export const parameters = {
  ...
  design: {
    type: 'figma',
    url: 'https://www.figma.com/design/ReGfRNillGABAj5SlITalN/📐-Gamut?node-id=55123-4176&node-type=frame&t=TtRz7Q9Kf1K69Hxe-0',
  },
  status: 'current',
  source: {
    repo: 'gamut',
...
|------|------|---------|-------------|
| `textColor` | `BoxProps['color']` | `'text'` | Color for text labels |
| `foregroundBarColor` | `BoxProps['color']` | `'text'` | Color for foreground/progress bar |
| `backgroundBarColor` | `BoxProps['color']` | `'primary'` | Color for background/total bar |
