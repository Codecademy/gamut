...
### YouTube Video (ReactVideoPlayer - No Captions)

<Canvas of={VideoStories.Youtube} />

### YouTube Video With Captions (VidstackPlayer)

<Canvas of={VideoStories.YoutubeWithCaptions} />

### Vimeo Video (ReactVideoPlayer - No Captions)

<Canvas of={VideoStories.Vimeo} />

### Multiple Video Sources

<Canvas of={VideoStories.MultipleVideoSources} />

### YouTube Without Embed (VidstackPlayer)

<Canvas of={VideoStories.YoutubeWithoutEmbed} />
