...
export const YoutubeWithCaptions: Story = {
  args: {
    videoUrl: 'https://www.youtube.com/watch?v=wxds6MAtUQ0',
    videoTitle: 'Intro to Programming: Loops',
    textTracks: [
...
export const MultipleVideoSources: Story = {
  args: {
    videoUrl: [
      {
        src: 'https://static-assets.codecademy.com/skillshorts/introduction-to-quantum-computing/01-Introduction-to-Quantum-Computing.mp4',
        type: 'video/mp4',
      },
      {
        src: 'https://static-assets.codecademy.com/skillshorts/introduction-to-quantum-computing/01-Introduction-to-Quantum-Computing.webm',
        type: 'video/webm',
      },
    ],
    videoTitle: 'Multi-Format Video',
  },
};

export const YoutubeWithoutEmbed: Story = {
  args: {
    videoUrl: 'https://www.youtube.com/watch?v=wxds6MAtUQ0',
    videoTitle: 'Intro to Programming: Loops (VidstackPlayer)',
