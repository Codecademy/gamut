...
This menu variant should be populated with MenuItems typed as buttons that execute some action.
...
This menu variant should be populated with MenuItems typed as links.
