...
### When NOT to use:
- For small, non-interactive contents, use a <LinkTo id="atoms-tooltip">ToolTip</LinkTo>
...
Tooltips with a _centered_ beak -`center`- are smaller sized and meant for a single small number of words, like keyboard shortcuts. Similar to the center aligned <LinkTo id="atoms-tooltip">ToolTip</LinkTo>
