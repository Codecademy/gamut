...
export const parameters = {
  ...
  source: {
    repo: 'gamut',
    githubLink: 'https://github.com/Codecademy/gamut/blob/main/packages/gamut/src/Popover/Popover.tsx'
  },
};
...
### When NOT to use:
- For small, non-interactive contents, use a **LinkTo id=**"atoms-tooltip--tool-tip"**ToolTip**LinkTo**
...
Tooltips with a _centered_ beak -`center`- are smaller sized and meant for a single small number of words, like keyboard shortcuts. Similar to the center aligned **tooltips**[KENNY: path please]/?path=/docs/atoms-tooltip--smaller-alignment#smaller-alignments
