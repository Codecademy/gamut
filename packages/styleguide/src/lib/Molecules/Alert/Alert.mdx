...
export const parameters = {
  ...
  source: {
    repo: 'gamut',
    githubLink: 'https://github.com/Codecademy/gamut/blob/main/packages/gamut/src/Alert/Alert.tsx'
  },
};
...
<Canvas of={AlertStories.TestingWithButton} />
...
<Canvas sourceState="shown" of={AlertStories.General} />
