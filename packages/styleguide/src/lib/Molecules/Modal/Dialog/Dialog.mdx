...
- Dialogs should always be displayed over an <LinkTo id="molecules-modal-overlay">Overlay</LinkTo>. Use the Overlay component in Gamut (and Figma) to capture the appropriate background opacity.
