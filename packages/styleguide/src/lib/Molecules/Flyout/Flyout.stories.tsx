...
// QUESTION!!!
// when rendering FlyoutExample, it only shows <FlyoutExample/> as the code
// But, when copy/pasta the whole thing in the render, it strips away the useState
const FlyoutExample: React.FC = (args) => {
