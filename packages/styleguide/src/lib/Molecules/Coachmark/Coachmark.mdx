...
The `Coachmark` component should be wrapped around the element you want to highlight.

```jsx
<Coachmark shouldShow={true} popoverProps={{ title: 'New Feature!' }}>
  <Button>New feature, with a Coachmark to call it out!</Button>
</Coachmark>
```
