...
This is to test the update of including zIndex as a prop in the Dialog (and Modal) component. This is not a real story and will be deleted after testing.
Test this by click on the "Testing Zindex" link on the left side of the navbar.
Testing via the iframe will not work since it's a different stacking context.

<Canvas of={DialogStories.TestingZindex} />

This is a comparison, where zIndex cannot be set for the Dialog, i.e. how it currently works in prod.

<Canvas of={DialogStories.TestingZindexComparison} />
