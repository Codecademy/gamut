...
- Dialog has light and dark theme variants that respond to the appropriate <LinkTo component="Foundations/ColorMode">Color Mode</LinkTo>.
...
- Dialogs should always be displayed over an <LinkTo component="Molecules/Modals/Overlay">Overlay</LinkTo>. Use the Overlay component in Gamut (and Figma) to capture the appropriate background opacity.
...
Dialog components respond to the current <LinkTo component="Foundations/ColorMode">Color Mode</LinkTo> they are used in. Each component inside of dialog will correctly display for the current color mode without any extra configuration.
Check it out:
