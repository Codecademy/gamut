import { VTTCue, parseVTTTimestamp } from './chunk-A5G7GA7F.js';
            ...
            if (this._format) {
              ...
              this._handleError(
                (_a = this._errorBuilder) == null
                  ? void 0
                  : _a._missingFormat('Style', lineCount)
              );
            }
          } else if (FORMAT_START_RE.test(line)) {
            this._format = line
              .replace(FORMAT_START_RE, '')
              .split(FORMAT_SPLIT_RE);
            ...
            if (this._format) {
              ...
              this._handleError(
                (_b = this._errorBuilder) == null
                  ? void 0
                  : _b._missingFormat('Dialogue', lineCount)
              );
            }
          } else if (this._cue) {
            this._cue.text +=
  ...
  _parseStyles(values) {
    ...
    if (borderStyle === 1 && typeof outlineX === 'number') {
      ...
      styles['--cue-text-shadow'] = [
        outlineColor &&
          buildTextShadow(outlineX * 1.2, outlineY * 1.2, outlineColor),
        outlineColor
          ? buildTextShadow(
              outlineX * (outlineX / 2),
              outlineY * (outlineX / 2),
...
//# sourceMappingURL=ssa-parser-WDZYLXOG.js.map
