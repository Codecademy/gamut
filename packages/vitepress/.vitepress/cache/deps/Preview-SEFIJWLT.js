...
var require_Preview = __commonJS({
  '../../node_modules/react-player/lib/Preview.js'(exports, module) {
    ...
    var Preview = class extends import_react.Component {
      ...
      render() {
        const { light, onClick, playIcon, previewTabIndex, previewAriaLabel } =
          this.props;
        ...
        const defaultPlayIcon = import_react.default.createElement(
          'div',
...
//# sourceMappingURL=Preview-SEFIJWLT.js.map
