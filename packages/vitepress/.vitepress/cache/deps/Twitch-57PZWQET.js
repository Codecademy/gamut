  ...
  '../../node_modules/react-player/lib/players/Twitch.js'(exports, module) {
    ...
    var Twitch = class extends import_react.Component {
      ...
      load(url, isReady) {
        ...
        const id = isChannel
          ? url.match(import_patterns.MATCH_URL_TWITCH_CHANNEL)[1]
          : url.match(import_patterns.MATCH_URL_TWITCH_VIDEO)[1];
        if (isReady) {
          if (isChannel) {
        ...
        (0, import_utils.getSDK)(SDK_URL, SDK_GLOBAL).then((Twitch2) => {
          ...
          const { READY, PLAYING, PAUSE, ENDED, ONLINE, OFFLINE, SEEK } =
            Twitch2.Player;
...
//# sourceMappingURL=Twitch-57PZWQET.js.map
