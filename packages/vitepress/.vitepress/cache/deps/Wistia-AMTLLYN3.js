      ...
      constructor() {
        ...
        __publicField(
          ...
          this.props.config.playerId ||
            `${PLAYER_ID_PREFIX}${(0, import_utils.randomString)()}`
        );
        ...
        __publicField(this, 'onPlaybackRateChange', (...args) =>
          this.props.onPlaybackRateChange(...args)
        );
...
//# sourceMappingURL=Wistia-AMTLLYN3.js.map
