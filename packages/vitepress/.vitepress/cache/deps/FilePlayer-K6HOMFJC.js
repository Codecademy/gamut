import { require_patterns, require_utils } from './chunk-GIXOYPWN.js';
...
var require_FilePlayer = __commonJS({
  '../../node_modules/react-player/lib/players/FilePlayer.js'(exports, module) {
    ...
    var FilePlayer = class extends import_react.Component {
      constructor() {
        super(...arguments);
        __publicField(this, 'onReady', (...args) =>
          this.props.onReady(...args)
        );
        __publicField(this, 'onPlay', (...args) => this.props.onPlay(...args));
        __publicField(this, 'onBuffer', (...args) =>
          this.props.onBuffer(...args)
        );
        __publicField(this, 'onBufferEnd', (...args) =>
          this.props.onBufferEnd(...args)
        );
        __publicField(this, 'onPause', (...args) =>
          this.props.onPause(...args)
        );
        __publicField(this, 'onEnded', (...args) =>
          this.props.onEnded(...args)
        );
        __publicField(this, 'onError', (...args) =>
          this.props.onError(...args)
        );
        __publicField(this, 'onPlayBackRateChange', (event) =>
          this.props.onPlaybackRateChange(event.target.playbackRate)
        );
        __publicField(this, 'onEnablePIP', (...args) =>
        ...
        __publicField(this, 'onPresentationModeChange', (e) => {
          if (
            this.player &&
            (0, import_utils.supportsWebKitPresentationMode)(this.player)
          ) {
        ...
        __publicField(this, 'renderTrack', (track, index) => {
          return import_react.default.createElement('track', {
            key: index,
            ...track,
          });
        });
      ...
      componentDidUpdate(prevProps) {
        ...
        if (
          ...
          !(0, import_utils.isMediaStream)(this.props.url) &&
      ...
      shouldUseAudio(props) {
        ...
        return (
          import_patterns.AUDIO_EXTENSIONS.test(props.url) ||
          props.config.forceAudio
        );
      }
      shouldUseHLS(url) {
        if (
          (IS_SAFARI && this.props.config.forceSafariHLS) ||
        ...
        return (
          import_patterns.HLS_EXTENSIONS.test(url) ||
          MATCH_CLOUDFLARE_STREAM.test(url)
        );
      }
      shouldUseDASH(url) {
        return (
          import_patterns.DASH_EXTENSIONS.test(url) ||
          this.props.config.forceDASH
        );
      }
      shouldUseFLV(url) {
        return (
          import_patterns.FLV_EXTENSIONS.test(url) || this.props.config.forceFLV
        );
      }
      load(url) {
...
//# sourceMappingURL=FilePlayer-K6HOMFJC.js.map
