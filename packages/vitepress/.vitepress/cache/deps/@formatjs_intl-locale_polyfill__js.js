...
// ../../node_modules/@formatjs/bigdecimal/index.js
...
var BigDecimal = class _BigDecimal {
  ...
  pow(n) {
    if (this._special === SpecialValue.NAN) return this;
    if (n === 0) return new _BigDecimal(1);
    if (n < 0) {
    ...
    if (this._special === SpecialValue.NEGATIVE_INFINITY) {
      return n % 2 === 0
        ? _BigDecimal._create(0n, 0, SpecialValue.POSITIVE_INFINITY, false)
        : this;
    }
    if (this._mantissa === 0n) return new _BigDecimal(0);
...
// ../../node_modules/@formatjs/intl-locale/node_modules/@formatjs/ecma402-abstract/constants.js
...
var createMemoizedLocale = memoize((...args) => new Intl.Locale(...args), {
  strategy: strategies.variadic,
});
...
// ../../node_modules/@formatjs/intl-locale/node_modules/@formatjs/ecma402-abstract/NumberFormat/decimal-cache.js
...
function processData() {
  ...
  if (!PROCESSED_DATA) {
    const paradigmLocales =
      (_b =
        (_a = data.supplemental.languageMatching['written-new'][0]) == null
          ? void 0
          : _a.paradigmLocales) == null
        ? void 0
        : _b._locales.split(' ');
    const matchVariables = data.supplemental.languageMatching[
      'written-new'
    ].slice(1, 5);
...
var RangePatternType = (function (RangePatternType3) {
  RangePatternType3['startRange'] = 'startRange';
  RangePatternType3['shared'] = 'shared';
  RangePatternType3['endRange'] = 'endRange';
  return RangePatternType3;
})({});

// ../../node_modules/@formatjs/intl-supportedvaluesof/src/memoize.js
var createMemoizedDateTimeFormat = memoize(
  (...args) => new Intl.DateTimeFormat(...args),
  { strategy: strategies.variadic }
);

// ../../node_modules/@formatjs/intl-supportedvaluesof/src/calendars.generated.js
var calendars = [
  'buddhist',
  'chinese',
  'coptic',
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/src/get-supported-calendars.js
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/src/collations.generated.js
var collations = [
  'big5han',
  'compat',
  'dict',
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/src/get-supported-collations.js
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/node_modules/@formatjs/ecma402-abstract/constants.js
var TEN2 = new BigDecimal(10);
var ZERO2 = new BigDecimal(0);
var NEGATIVE_ZERO2 = new BigDecimal(-0);

// ../../node_modules/@formatjs/intl-supportedvaluesof/node_modules/@formatjs/ecma402-abstract/utils.js
var createMemoizedNumberFormat2 = memoize(
  (...args) => new Intl.NumberFormat(...args),
  { strategy: strategies.variadic }
);
var createMemoizedPluralRules2 = memoize(
  (...args) => new Intl.PluralRules(...args),
  { strategy: strategies.variadic }
);
var createMemoizedLocale2 = memoize((...args) => new Intl.Locale(...args), {
  strategy: strategies.variadic,
});
var createMemoizedListFormat2 = memoize(
  (...args) => new Intl.ListFormat(...args),
  { strategy: strategies.variadic }
);

// ../../node_modules/@formatjs/intl-supportedvaluesof/node_modules/@formatjs/ecma402-abstract/262.js
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/node_modules/@formatjs/ecma402-abstract/IsSanctionedSimpleUnitIdentifier.js
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/node_modules/@formatjs/ecma402-abstract/NumberFormat/decimal-cache.js
var getPowerOf102 = memoize((exponent) => {
  return BigDecimal.pow(10, exponent);
});

// ../../node_modules/@formatjs/intl-supportedvaluesof/node_modules/@formatjs/ecma402-abstract/regex.generated.js
var S_UNICODE_REGEX2 =
  /[\$\+<->\^`\|~\xA2-\xA6\xA8\xA9\xAC\xAE-\xB1\xB4\xB8\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u02FF\u0375\u0384\u0385\u03F6\u0482\u058D-\u058F\u0606-\u0608\u060B\u060E\u060F\u06DE\u06E9\u06FD\u06FE\u07F6\u07FE\u07FF\u0888\u09F2\u09F3\u09FA\u09FB\u0AF1\u0B70\u0BF3-\u0BFA\u0C7F\u0D4F\u0D79\u0E3F\u0F01-\u0F03\u0F13\u0F15-\u0F17\u0F1A-\u0F1F\u0F34\u0F36\u0F38\u0FBE-\u0FC5\u0FC7-\u0FCC\u0FCE\u0FCF\u0FD5-\u0FD8\u109E\u109F\u1390-\u1399\u166D\u17DB\u1940\u19DE-\u19FF\u1B61-\u1B6A\u1B74-\u1B7C\u1FBD\u1FBF-\u1FC1\u1FCD-\u1FCF\u1FDD-\u1FDF\u1FED-\u1FEF\u1FFD\u1FFE\u2044\u2052\u207A-\u207C\u208A-\u208C\u20A0-\u20C1\u2100\u2101\u2103-\u2106\u2108\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A\u213B\u2140-\u2144\u214A-\u214D\u214F\u218A\u218B\u2190-\u2307\u230C-\u2328\u232B-\u2429\u2440-\u244A\u249C-\u24E9\u2500-\u2767\u2794-\u27C4\u27C7-\u27E5\u27F0-\u2982\u2999-\u29D7\u29DC-\u29FB\u29FE-\u2B73\u2B76-\u2BFF\u2CE5-\u2CEA\u2E50\u2E51\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFF\u3004\u3012\u3013\u3020\u3036\u3037\u303E\u303F\u309B\u309C\u3190\u3191\u3196-\u319F\u31C0-\u31E5\u31EF\u3200-\u321E\u322A-\u3247\u3250\u3260-\u327F\u328A-\u32B0\u32C0-\u33FF\u4DC0-\u4DFF\uA490-\uA4C6\uA700-\uA716\uA720\uA721\uA789\uA78A\uA828-\uA82B\uA836-\uA839\uAA77-\uAA79\uAB5B\uAB6A\uAB6B\uFB29\uFBB2-\uFBD2\uFD40-\uFD4F\uFD90\uFD91\uFDC8-\uFDCF\uFDFC-\uFDFF\uFE62\uFE64-\uFE66\uFE69\uFF04\uFF0B\uFF1C-\uFF1E\uFF3E\uFF40\uFF5C\uFF5E\uFFE0-\uFFE6\uFFE8-\uFFEE\uFFFC\uFFFD]|\uD800[\uDD37-\uDD3F\uDD79-\uDD89\uDD8C-\uDD8E\uDD90-\uDD9C\uDDA0\uDDD0-\uDDFC]|\uD802[\uDC77\uDC78\uDEC8]|\uD803[\uDD8E\uDD8F\uDED1-\uDED8]|\uD805\uDF3F|\uD807[\uDFD5-\uDFF1]|\uD81A[\uDF3C-\uDF3F\uDF45]|\uD82F\uDC9C|\uD833[\uDC00-\uDCEF\uDCFA-\uDCFC\uDD00-\uDEB3\uDEBA-\uDED0\uDEE0-\uDEF0\uDF50-\uDFC3]|\uD834[\uDC00-\uDCF5\uDD00-\uDD26\uDD29-\uDD64\uDD6A-\uDD6C\uDD83\uDD84\uDD8C-\uDDA9\uDDAE-\uDDEA\uDE00-\uDE41\uDE45\uDF00-\uDF56]|\uD835[\uDEC1\uDEDB\uDEFB\uDF15\uDF35\uDF4F\uDF6F\uDF89\uDFA9\uDFC3]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85\uDE86]|\uD838[\uDD4F\uDEFF]|\uD83B[\uDCAC\uDCB0\uDD2E\uDEF0\uDEF1]|\uD83C[\uDC00-\uDC2B\uDC30-\uDC93\uDCA0-\uDCAE\uDCB1-\uDCBF\uDCC1-\uDCCF\uDCD1-\uDCF5\uDD0D-\uDDAD\uDDE6-\uDE02\uDE10-\uDE3B\uDE40-\uDE48\uDE50\uDE51\uDE60-\uDE65\uDF00-\uDFFF]|\uD83D[\uDC00-\uDED8\uDEDC-\uDEEC\uDEF0-\uDEFC\uDF00-\uDFD9\uDFE0-\uDFEB\uDFF0]|\uD83E[\uDC00-\uDC0B\uDC10-\uDC47\uDC50-\uDC59\uDC60-\uDC87\uDC90-\uDCAD\uDCB0-\uDCBB\uDCC0\uDCC1\uDCD0-\uDCD8\uDD00-\uDE57\uDE60-\uDE6D\uDE70-\uDE7C\uDE80-\uDE8A\uDE8E-\uDEC6\uDEC8\uDECD-\uDEDC\uDEDF-\uDEEA\uDEEF-\uDEF8\uDF00-\uDF92\uDF94-\uDFEF\uDFFA]/;

// ../../node_modules/@formatjs/intl-supportedvaluesof/node_modules/@formatjs/ecma402-abstract/NumberFormat/format_to_parts.js
var CARET_S_UNICODE_REGEX2 = new RegExp(`^${S_UNICODE_REGEX2.source}`);
var S_DOLLAR_UNICODE_REGEX2 = new RegExp(`${S_UNICODE_REGEX2.source}$`);

// ../../node_modules/@formatjs/intl-supportedvaluesof/node_modules/@formatjs/ecma402-abstract/types/date-time.js
var RangePatternType2 = (function (RangePatternType3) {
  RangePatternType3['startRange'] = 'startRange';
  RangePatternType3['shared'] = 'shared';
  RangePatternType3['endRange'] = 'endRange';
  return RangePatternType3;
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/src/currencies.generated.js
var currencies = [
  'ADP',
  'AED',
  'AFA',
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/src/get-supported-currencies.js
function isSupportedCurrency(currency) {
  try {
    const numberFormat = createMemoizedNumberFormat2('en', {
      style: 'currency',
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/src/numbering-systems.generated.js
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/src/get-supported-numbering-systems.js
function isSupportedNumberingSystem(system) {
  try {
    const numberFormat = createMemoizedNumberFormat2(`en-u-nu-${system}`);
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/src/timezones.generated.js
var timezones = [
  'Africa/Abidjan',
  'Africa/Accra',
  'Africa/Addis_Ababa',
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/src/get-supported-timezones.js
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/src/units.generated.js
var units = [
  'degree',
  'acre',
  'hectare',
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/src/get-supported-units.js
function isSupportedUnit(unit) {
  try {
    const formatter = createMemoizedNumberFormat2('en', {
      style: 'unit',
      unit,
    });
...
// ../../node_modules/@formatjs/intl-supportedvaluesof/src/index.js
...
var numberingSystems = {
  ...
  'yue-Hans': ['latn', 'hanidec', 'hant', 'hantfin'],
  'yue-Hant': ['latn', 'hanidec', 'hant', 'hantfin'],
  'yue-Hant-CN': ['latn', 'hanidec', 'hant', 'hantfin'],
  'yue-Hant-MO': ['latn', 'hanidec', 'hant', 'hantfin'],
  za: ['latn'],
  zgh: ['latn'],
...
function getCalendarPreferenceDataForRegion(region) {
  ...
  return (calendars2[_region || ''] || calendars2['001']).map((c) => {
    if (c === 'gregorian') {
      return 'gregory';
    }
    if (c === 'islamic-civil') {
...
var RELEVANT_EXTENSION_KEYS = ['ca', 'co', 'hc', 'kf', 'kn', 'nu', 'fw'];
...
function addLikelySubtags(tag) {
  ...
  if (script && region) {
    ...
    if (match2) {
      const parts2 = parseUnicodeLanguageId(match2);
...
function numberingSystemsOfLocale(loc) {
  ...
  const localeNumberingSystems =
    numberingSystems[locale] ?? numberingSystems[language];
...
var _Locale = class _Locale {
  constructor(tag, opts) {
    const newTarget =
      this && this instanceof _Locale ? this.constructor : void 0;
    if (!newTarget) {
...
//# sourceMappingURL=@formatjs_intl-locale_polyfill__js.js.map
