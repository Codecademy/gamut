import { require_patterns } from './chunk-GIXOYPWN.js';
  ...
  '../../node_modules/react-player/lib/players/Mux.js'(exports, module) {
    ...
    var Mux = class extends import_react.Component {
      ...
      async load(url) {
        ...
        if (
          !((_a = globalThis.customElements) == null
            ? void 0
            : _a.get('mux-player'))
        ) {
          try {
      ...
      render() {
        ...
        return import_react.default.createElement('mux-player', {
          ref: this.ref,
...
//# sourceMappingURL=Mux-D3QJ37ND.js.map
