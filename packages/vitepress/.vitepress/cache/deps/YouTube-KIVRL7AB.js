    ...
    var YouTube = class extends import_react.Component {
      constructor() {
        ...
        __publicField(this, 'onStateChange', (event) => {
          ...
          const { UNSTARTED, PLAYING, PAUSED, BUFFERING, ENDED, CUED } =
      ...
      load(url, isReady) {
        const { playing, muted, playsinline, controls, loop, config, onError } =
          this.props;
        ...
        if (isReady) {
          ...
          this.player.cueVideoById({
            videoId: id,
            startSeconds:
              (0, import_utils.parseStartTime)(url) || playerVars.start,
          ...
          this.player = new YT.Player(this.container, {
            ...
            events: {
              ...
              onPlaybackRateChange: (event) =>
                this.props.onPlaybackRateChange(event.data),
      ...
      render() {
        ...
        return import_react.default.createElement(
          'div',
          { style },
          import_react.default.createElement('div', { ref: this.ref })
        );
      }
    };
...
//# sourceMappingURL=YouTube-KIVRL7AB.js.map
