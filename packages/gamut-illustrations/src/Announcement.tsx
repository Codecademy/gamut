...
export const Announcement: React.FC<IllustrationProps> = ({
  ...
  >
    <mask
      ...
      height="83"
    >
      <circle cx="240.5" cy="53.5" r="41.5" fill="#D9D9D9" />
    </mask>
    <g mask="url(#a)">
      <mask
        id="c"
        ...
        height="83"
      >
        <path fill="url(#b)" d="M199 12h83v83h-83z" />
      </mask>
      <g mask="url(#c)">
        <path fill="#FFD300" d="M199 12h83v83h-83z" />
      </g>
    </g>
    <path
    ...
    <defs>
      <pattern
        ...
        height=".048"
      >
        <use xlinkHref="#e" transform="scale(.01205)" />
      </pattern>
      <pattern
        id="d"
        patternContentUnits="objectBoundingBox"
        ...
        height=".808"
      >
        <use xlinkHref="#f" transform="scale(.03583 .01262)" />
      </pattern>
      <image
        id="e"
        width="4"
