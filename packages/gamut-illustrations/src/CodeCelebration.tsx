...
export const CodeCelebration: React.FC<IllustrationProps> = ({
  ...
  >
    ...
    <rect
      ...
      strokeWidth="1.103"
    />
    <path fill="#fff" d="M240.075 15.916v129.98H71.49V15.915z" />
    <path
    ...
    <defs>
      <pattern
        ...
        height=".208"
      >
        <use xlinkHref="#d" transform="scale(.0042 .00325)" />
      </pattern>
      <pattern
        id="b"
        patternContentUnits="objectBoundingBox"
        ...
        height=".169"
      >
        <use xlinkHref="#d" transform="scale(.04885 .00264)" />
      </pattern>
      <pattern
        id="c"
        patternContentUnits="objectBoundingBox"
        ...
        height=".776"
      >
        <use xlinkHref="#d" transform="scale(.01683 .01213)" />
      </pattern>
      <image
        id="d"
        width="64"
