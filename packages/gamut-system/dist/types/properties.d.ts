...
export declare type Props = {
    ...
    borderWidth: {
        ...
        altProps: 'borderWidthLeft' | 'borderWidthRight' | 'borderWidthTop' | 'borderWidthBottom' | 'borderWidthX' | 'borderWidthY';
    };
    borderRadius: {
        defaultValue: CSS.Properties['borderRadius'];
    };
    borderStyle: {
        defaultValue: CSS.Property.BorderTopStyle;
    };
    /** Shadows */
    boxShadow: {
    ...
    margin: {
        ...
        altProps: 'marginLeft' | 'marginRight' | 'marginTop' | 'marginBottom' | 'marginX' | 'marginY';
    };
    padding: {
        defaultValue: CSS.Properties['padding'];
        altProps: 'paddingLeft' | 'paddingRight' | 'paddingTop' | 'paddingBottom' | 'paddingX' | 'paddingY';
    };
    /** Layout */
    display: {
    ...
    borderColor: {
        ...
        altProps: 'borderColorLeft' | 'borderColorRight' | 'borderColorTop' | 'borderColorBottom' | 'borderColorX' | 'borderColorY';
    };
    backgroundColor: {
