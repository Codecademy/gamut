...
export declare type PropertyUnion = {
    [P in keyof Properties]: {
        propName: P;
    } & Properties[P];
}[keyof Properties];
export declare type PropName = PropertyUnion['propName'];
export declare type Property = Exclude<PropertyUnion, {
    property: string;
}>['propName'] | Extract<PropertyUnion, {
    property: string;
}>['property'];
export declare type DirectionalProperty = Extract<PropertyUnion, {
    dependentProps: string;
}>['propName'];
export declare type AllPropertiesAndDependents = PropertyUnion['propName'] | Extract<PropertyUnion, {
    dependentProps: string;
}>['dependentProps'];
