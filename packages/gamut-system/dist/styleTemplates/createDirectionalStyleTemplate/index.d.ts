 ...
 */
export declare function createDirectionalStyleTemplate<Props extends AbstractProps, Config extends AbstractPropertyConfig & Required<Pick<AbstractPropertyConfig, 'propName' | 'transformValue'>>>(config: Config): StyleTemplate<Props>;
