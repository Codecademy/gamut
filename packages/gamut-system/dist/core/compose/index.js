...
export var compose = function compose() {
  ...
  var config = handlers.reduce(function (accum, handler) {
    return {
      propNames: [].concat(_toConsumableArray(accum.propNames), _toConsumableArray(handler.propNames)),
      styleTemplates: _objectSpread(_objectSpread({}, accum.styleTemplates), handler.styleTemplates)
    };
  }, {
    propNames: [],
    styleTemplates: {}
