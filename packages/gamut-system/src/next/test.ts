...
export const {
  css,
  variant,
  properties: { fontSize, fontWeight, fontFamily },
} = variance.withTheme<Theme>().create({
  fontSize: { prop: 'fontSize', scale: 'fontSize' },
  fontWeight: { prop: 'fontWeight', scale: 'fontWeight' },
  fontFamily: { prop: 'fontFamily' },
  padding: {
    prop: 'padding',
    dependentProps: ['paddingX', 'paddingY'],
    scale: 'spacing',
  },
});
