...
import { stubSelectField, stubTextField, stubCheckboxField } from '../../__tests__/stubs';
...
describe('GridFormInputGroup', function () {
  ...
  it('renders a checkbox input when the field type is checkbox', function () {
  ...
  it('renders a text input when the field type is text', function () {
    var _renderComponent4 = renderComponent({
      field: stubTextField
        ...
        wrapped = _renderComponent4.wrapped;
