...
2. Add each of the managed packages to your peer dependencies (this is requried for enabling intellisense for these packages and does not have any effect on version resolution)
